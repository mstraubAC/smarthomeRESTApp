...
type HeatpumpPowerAggregatesMonthlyType struct {
	Logdate                                  time.Time       `json:"logdate" db:"logdate"`
	MonthlyWorkCoefficient                   zeronull.Float8 `json:"monthlyWorkCoefficient" db:"monatsarbeitszahlinclcontrolandpumps"`
	MonthlyWorkCoefficientHeatSourceOnly     zeronull.Float8 `json:"monthlyWorkCoefficientHeatSourceOnly" db:"monatsarbeitszahlsolvis"`
	MonthlyWorkCoefficientIncludingControl   zeronull.Float8 `json:"monthlyWorkCoefficientIncludingControl" db:"monatsarbeitszahlfullelectricmeasurement"`
